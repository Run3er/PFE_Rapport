...
\usepackage{amssymb}% http://ctan.org/pkg/amssymb % checkmark signs
\usepackage{pifont}% http://ctan.org/pkg/pifont % checkmark signs
\newcommand{\cmark}{\ding{51}}% checkmark signs
\newcommand{\xmark}{\ding{55}}% checkmark signs
\newcommand{\ie}{c.-\`a-d.~}
...
%\singlespacing
\renewcommand{\bibname}{Bibliographie - BIDON}
